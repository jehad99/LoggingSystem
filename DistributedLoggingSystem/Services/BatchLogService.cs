...
namespace DistributedLoggingSystem.Services
{
    public class BatchLogService
    {
        ...
        public BatchLogService(S3HttpClientService s3Service, IConfiguration configuration, LoggingDbContext context)
        {
        ...
        private async Task FlushBufferAsync()
        {
            ...
            try
            {
                ...
                await _s3Service.UploadFileAsync(_bucketName, fileName, compressedContent);
        ...
        private async Task<string> DownloadAndDecompressAsync(string key)
        {
            try
            {
                var content = await _s3Service.DownloadFileAsync(_bucketName, key);
            ...
            {
                Console.WriteLine($"Error downloading and decompressing file: {ex.Message}");
                throw;
            }
        }
